...
export default async function Home() {
  ...
  return (
    <main className="container">
      <div className="hero">
        <h1>Seu projeto em metal, do jeito certo.</h1>
        <p>
          Escolha o modelo, configure medidas e finalize pelo WhatsApp. Promoções, ofertas B2B e destaques aparecem automaticamente.
        </p>

        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 14 }}>
          <a className="pill pillPrimary" href="/catalogo">Ver catálogo</a>
          <a className="pill" href="/carrinho">Ir para o carrinho</a>
          <a className="pill" href="/construtor/login">Sou construtor (B2B)</a>
        </div>
      </div>
